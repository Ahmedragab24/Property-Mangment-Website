    ...
    <section className="partners">
      <div className="mt-16">
        <div className="flex flex-col text-center w-full mb-20">
          <h1 className="text-xl lg:text-2xl font-medium title-font mb-4 text-shadow-primary">
            Partner Success Stories
          </h1>
          <p className="w-full lg:w-2/3 mx-auto leading-relaxed text-base text-textColor">
            ...
            <SwiperSlide key={index} className="w-full p-2">
              <div className="flex relative shadow-lg">
                ...
                <div className="px-8 py-10 relative z-10 w-full border-2 border-primary bg-secondary duration-500 opacity-0 rounded-lg hover:opacity-100">
                  ...
                  <p className="leading-relaxed text-[11px] lg:text-sm">
                    {description}
                  </p>
                </div>
              </div>
